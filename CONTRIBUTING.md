Contributing to TradePlus_Coin
============================

The TradePlus_Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/tradeplus_coin-project/tradeplus_coin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the TradePlus_Coin project, and is not to be
confused with overall TradePlus_Coin Network Protocol consensus changes.

Whether a pull request is merged into TradePlus_Coin rests with the project merge
...
Patches that change TradePlus_Coin consensus rules are considerably more involved than
...
Where a patchset proposes to change the TradePlus_Coin consensus, it must have been
...
The project leader is the release manager for each TradePlus_Coin release.
