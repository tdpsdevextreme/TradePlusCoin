...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TradePlus Coin tradeplus_coin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  tradeplus_coin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded tradeplus_coin transaction") + "\n" +
                               "  tradeplus_coin-tx [options] -create [commands]   " + _("Create hex-encoded tradeplus_coin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded tradeplus_coin transaction
