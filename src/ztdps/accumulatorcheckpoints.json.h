...
#ifndef TradePlus_Coin_ACCUMULATORCHECKPOINTS_JSON_H
#define TradePlus_Coin_ACCUMULATORCHECKPOINTS_JSON_H
...
#endif //TradePlus_Coin_ACCUMULATORCHECKPOINTS_JSON_H
