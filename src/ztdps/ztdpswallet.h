...
#ifndef TradePlus_Coin_ZTDPSWALLET_H
#define TradePlus_Coin_ZTDPSWALLET_H
...
public:
    CzTDPSWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZTDPS(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZTDPS(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //TradePlus_Coin_ZTDPSWALLET_H
