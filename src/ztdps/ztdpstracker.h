...
#ifndef TradePlus_Coin_ZTDPSTRACKER_H
#define TradePlus_Coin_ZTDPSTRACKER_H
...
public:
    CzTDPSTracker(std::string strWalletFile);
    ~CzTDPSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzTDPSWallet* zTDPSWallet = NULL);
...
#endif //TradePlus_Coin_ZTDPSTRACKER_H
