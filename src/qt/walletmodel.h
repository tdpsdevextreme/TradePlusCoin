...
#ifndef TradePlus_Coin_QT_WALLETMODEL_H
#define TradePlus_Coin_QT_WALLETMODEL_H
...
/** Interface to TradePlus_Coin wallet from Qt view code. */
...
#endif // TradePlus_Coin_QT_WALLETMODEL_H
