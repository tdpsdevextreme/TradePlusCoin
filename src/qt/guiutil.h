...
/** Utility functions used by the TradePlus_Coin Qt UI.
 */
namespace GUIUtil
{
...
// Render TradePlus_Coin addresses in monospace font
...
// Parse "tradeplus_coin:" URI into recipient object, return true on successful parsing
