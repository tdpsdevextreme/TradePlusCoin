...
#include "qt/tradeplus_coin/forms/ui_requestdialog.h"
#include <QListView>
    ...
    ui(new Ui::RequestDialog)
{
    ...
    ui->labelMessage->setText(tr("Instead of share a TradePlus Coin address, you can create a Payment Request message which bundles up more information than is contained in just a TradePlus Coin address."));
    ...
    ui->comboBoxCoin->addItem("TDPS", 0);
    ...
    ui->lineEditAmount->setPlaceholderText("0.00 TDPS");
...
void RequestDialog::onNextClicked(){
    if(walletModel) {
        ...
        ui->labelTitle->setText("Request for " + BitcoinUnits::format(displayUnit, value, false, BitcoinUnits::separatorAlways) + " TDPS");
