...
#include "qt/tradeplus_coin/coincontroltdpswidget.h"
#include "qt/tradeplus_coin/forms/ui_coincontroltdpswidget.h"

CoinControlTdpsWidget::CoinControlTdpsWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlTdpsWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select TDPS Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("TDPS");
    ...
    ui->labelValueAfter->setText("0.00 TDPS");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 TDPS");
    ui->labelValueFee->setText("0.00 TDPS");
...
CoinControlTdpsWidget::~CoinControlTdpsWidget()
{
    delete ui;
}
