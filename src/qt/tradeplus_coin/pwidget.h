...
#include <QString>
#include <QThread>
#include "qt/tradeplus_coin/prunnable.h"
...
class PWidget : public QWidget, public Runnable
{
    Q_OBJECT
public:
    explicit PWidget(TradePlus_CoinGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    TradePlus_CoinGUI* getWindow() { return this->window; }
...
protected:
    TradePlus_CoinGUI* window = nullptr;
