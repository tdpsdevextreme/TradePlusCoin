...
#include "qt/tradeplus_coin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/tradeplus_coin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(TradePlus_CoinGUI* _window, QWidget *parent) :
