...
#include "qt/tradeplus_coin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(TradePlus_CoinGUI* _window, QWidget *parent) :
