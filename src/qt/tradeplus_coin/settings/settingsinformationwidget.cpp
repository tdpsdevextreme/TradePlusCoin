...
#include "qt/tradeplus_coin/settings/forms/ui_settingsinformationwidget.h"
...
SettingsInformationWidget::SettingsInformationWidget(TradePlus_CoinGUI* _window,QWidget *parent) :
