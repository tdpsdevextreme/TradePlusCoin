...
#include "qt/tradeplus_coin/settings/forms/ui_settingsconsolewidget.h"
...
SettingsConsoleWidget::SettingsConsoleWidget(TradePlus_CoinGUI* _window, QWidget *parent) :
