...
#include "qt/tradeplus_coin/settings/forms/ui_settingswalletrepairwidget.h"
...
SettingsWalletRepairWidget::SettingsWalletRepairWidget(TradePlus_CoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to TradePlus_CoinGUI::handleRestart()
