...
#include "qt/tradeplus_coin/forms/ui_addresseswidget.h"
#include "qt/tradeplus_coin/addresslabelrow.h"
#include "qt/tradeplus_coin/addnewaddressdialog.h"
#include "qt/tradeplus_coin/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(TradePlus_CoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::AddressesWidget)
{
    ...
    // Address
    ui->labelAddress->setText(tr("Enter a TradePlus Coin address"));
...
void AddressesWidget::onStoreContactClicked(){
    if (walletModel) {
        ...
        CBitcoinAddress tdpsAdd = CBitcoinAddress(address.toUtf8().constData());
        ...
        if (walletModel->updateAddressBookLabels(tdpsAdd.Get(), label.toUtf8().constData(), "send")) {
