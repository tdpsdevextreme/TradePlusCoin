...
#include "qt/tradeplus_coin/furabstractlistitemdelegate.h"
#include "qt/tradeplus_coin/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/tradeplus_coin/txviewholder.h"
...
#include "config/tradeplus_coin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
	...
	qint64 totalTdps = 0;
	qint64 totalzTdps = 0;
	QList<qreal> valuesTdps;
	QList<qreal> valueszTdps;
	QStringList xLabels;
};
...
public:
	explicit DashboardWidget(TradePlus_CoinGUI* _window);
	~DashboardWidget();
