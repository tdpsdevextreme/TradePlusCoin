...
void TransactionFilterProxy::setStakeMN(bool fStakeMN) {
	this->fStakeMN = fStakeMN;
	invalidateFilter();
}
...
bool TransactionFilterProxy::isOrphan(const int status, const int type)
{
    return ( (type == TransactionRecord::Generated || type == TransactionRecord::StakeMint ||
            type == TransactionRecord::StakeZTDPS || type == TransactionRecord::MNReward)
...
bool TransactionFilterProxy::isZcTx(int type) const {
    return (type == TransactionRecord::ZerocoinMint || type == TransactionRecord::ZerocoinSpend || type == TransactionRecord::ZerocoinSpend_Change_zTdps
...
bool TransactionFilterProxy::isStakeTx(int type) const {
    return (type == TransactionRecord::StakeMint || type == TransactionRecord::Generated || type == TransactionRecord::StakeZTDPS);
}

bool TransactionFilterProxy::isStakeMN(int type) const {
	return (type == TransactionRecord::StakeMint || type == TransactionRecord::MNReward);
}
