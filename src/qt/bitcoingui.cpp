...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TradePlus Coin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and tradeplus coin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zTDPS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TradePlus Coin"), this);
    aboutAction->setStatusTip(tr("Show information about TradePlus Coin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for TradePlus Coin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TradePlus Coin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TradePlus Coin addresses"));
    ...
    multisigSpendAction = new QAction(QIcon(), tr("&Multisignature spending..."), this);
    ...
    openAction->setStatusTip(tr("Open a TradePlus Coin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TradePlus Coin help message to get a list with possible TradePlus Coin command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TradePlus Coin network", "", count));
}
