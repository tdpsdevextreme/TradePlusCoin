...
/** Interface from Qt to configuration data structure for TradePlus_Coin client.
...
public:
    ...
    enum OptionID {
        ...
        HideOrphans,    // bool
        AnonymizeTradeplus_CoinAmount, //int
...
signals:
    ...
    void anonymizeTradeplus_CoinAmountChanged(int);
