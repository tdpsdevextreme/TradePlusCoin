...
public:
    ...
    void setZTdpsControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzTDPS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzTDPS_clicked();
    void on_pushButtonZTdpsControl_clicked();
