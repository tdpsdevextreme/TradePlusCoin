                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzTDPSPathCustom = GetArg("-ztdpsbackuppath", "");
    ...
    if(!strzTDPSPathCustom.empty()) {
        ui->wallet_customztdpsbackuppath->setText(QString::fromStdString(strzTDPSPathCustom));
        ui->wallet_customztdpsbackuppath_label->setVisible(true);
        ui->wallet_customztdpsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzTDPSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the TradePlus Coin RPC console.") + "<br>" +
