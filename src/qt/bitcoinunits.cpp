...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(TDPS);
    unitlist.append(mTDPS);
    unitlist.append(uTDPS);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case TDPS:
        return QString("tradeplus_coin");
    case mTDPS:
        return QString("mtradeplus_coin");
    case uTDPS:
        return QString::fromUtf8("utradeplus_coin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::name(int unit)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case TDPS:
            return QString("TDPS");
        case mTDPS:
            return QString("mTDPS");
        case uTDPS:
            return QString::fromUtf8("μTDPS");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case TDPS:
            return QString("tTDPS");
        case mTDPS:
            return QString("mtTDPS");
        case uTDPS:
            return QString::fromUtf8("μtTDPS");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case TDPS:
            return QString("TDPS");
        case mTDPS:
            return QString("Milli-TDPS (1 / 1" THIN_SP_UTF8 "000)");
        case uTDPS:
            return QString("Micro-TDPS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case TDPS:
            return QString("TestTDPSs");
        case mTDPS:
            return QString("Milli-TestTDPS (1 / 1" THIN_SP_UTF8 "000)");
        case uTDPS:
            return QString("Micro-TestTDPS (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
