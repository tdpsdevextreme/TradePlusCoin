...
CAmount AmountFromValue(const UniValue& value)
{
    ...
    if (dAmount <= 0.0 || dAmount > 80000000.0)
...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop TradePlus Coin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "TradePlus Coin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TradePlus_Coin features */
        {"tradeplus_coin", "listmasternodes", &listmasternodes, true, true, false},
        {"tradeplus_coin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"tradeplus_coin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"tradeplus_coin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"tradeplus_coin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"tradeplus_coin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"tradeplus_coin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"tradeplus_coin", "masternodedebug", &masternodedebug, true, true, false},
        {"tradeplus_coin", "startmasternode", &startmasternode, true, true, false},
        {"tradeplus_coin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"tradeplus_coin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"tradeplus_coin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"tradeplus_coin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"tradeplus_coin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"tradeplus_coin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"tradeplus_coin", "preparebudget", &preparebudget, true, true, false},
        {"tradeplus_coin", "submitbudget", &submitbudget, true, true, false},
        {"tradeplus_coin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"tradeplus_coin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"tradeplus_coin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"tradeplus_coin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"tradeplus_coin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"tradeplus_coin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"tradeplus_coin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"tradeplus_coin", "checkbudgets", &checkbudgets, true, true, false},
        {"tradeplus_coin", "mnsync", &mnsync, true, true, false},
        {"tradeplus_coin", "spork", &spork, true, true, false},
        {"tradeplus_coin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> tradeplus_coin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17113/\n";
}
