 ...
 * TradePlus_Coin system. There are three: the main network on which people trade goods
...
public:
    ...
    int Tradeplus_CoinBadBlockTime() const { return nTradeplus_CoinBadBlockTime; }
    int Tradeplus_CoinBadBlocknBits() const { return nTradeplus_CoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nTradeplus_CoinBadBlockTime;
    unsigned int nTradeplus_CoinBadBlocknBits;
