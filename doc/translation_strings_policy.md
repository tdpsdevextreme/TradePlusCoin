...
This document provides guidelines for internationalization of the TradePlus_Coin software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to TradePlus_Coin network</numerusform>
            <numerusform>%n active connections to TradePlus_Coin network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `tradeplus_coin_en.ts` remains unchanged.
