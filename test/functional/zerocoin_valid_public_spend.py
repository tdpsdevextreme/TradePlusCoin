...
from fake_stake.base_test import TradePlus_Coin_FakeStakeTest

class zTDPSValidCoinSpendTest(TradePlus_Coin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zTDPSs..." % DENOM_TO_USE)
